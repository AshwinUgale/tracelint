...
**Website: [tracelint.com](https://tracelint.com)** — what it catches, how it works, and how to
wire it into CI.

**[See a live demo report](https://ashwinugale.github.io/tracelint/demo/)** — the constructed
