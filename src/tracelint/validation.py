...
def validation_cases() -> list[ValidationCase]:
    ...
    cases.append(
        ValidationCase(
            ...
            "R1 hard_defect",
            _has("R1", ConfidenceTier.HARD_DEFECT),
        )
    )
    ...
    cases.append(
        ValidationCase(
            ...
            "R2a hard_event",
            _has("R2a", ConfidenceTier.HARD_EVENT),
        )
    )
    ...
    cases.append(
        ValidationCase(
            ...
            loop_trace,
            loop_toolset.to_registry(),
            "R4 loop candidate",
            _has("R4", ConfidenceTier.CANDIDATE),
        )
    )
    ...
    cases.append(
        ValidationCase(
            ...
            ToolRegistry(),
            "R5 redundant candidate",
            _has("R5", ConfidenceTier.CANDIDATE),
        )
    )
    ...
    cases.append(
        ValidationCase(
            ...
            ToolRegistry(),
            "no loop, no hard_defect",
            _and(_no_rule("R4"), _no_hard_defect()),
        )
    )
